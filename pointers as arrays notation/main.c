...
int main()
{
    ...
    /* output array b using array name and pointer/index notation */
    printf( "\nPointer/index notation where\n the pointer is the array name\n" );
    for(index = 0 ; index < array_size ; index++){
        printf( "*( A + %d ) = %d\n", index, *(A+index) );
    }
    /* output array b using p_arr and array subscript notation */
    printf( "\nPointer subscript notation\n" );
    for(i = 0 ; i < array_size ; i++){
        printf( "p_arr[ %d ] = %d\n", i,p_arr[i] );
    }
    /* output array b using p_arr and pointer/index notation */
